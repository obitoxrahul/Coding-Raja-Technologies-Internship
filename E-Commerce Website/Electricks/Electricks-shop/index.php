...
<body class="index-page sidebar-collapse">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a href="pages/admin_login_page.php" class="nav-link" onclick="scrollToDownload()">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('SPL-L1.png');">
            
                <div class="container">
                    <div class="content-center brand">
                        <img src="" class="rounded-circle">
                        <br><br><h3>Mobile phone , laptops , Smartwatch , Headphones, Sensors, and Electronic components.
                        </h3>
                    </div>
                </div>
            </div>
