              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Manila City">Karnataka</option>
                      <option value="Caloocan City">Jharkhand</option>
                      <option value="Las Pinas City">Odisha</option>
                      <option value="Makati City">Bihar</option>
                      <option value="Malabon City">Delhi</option>
                      <option value="Mandaluyong City">Telangana</option>
                      <option value="Marikina City">Andra Pradesh</option>
                      <option value="Muntinlupa City">Arunachal Pradesh</option>
                      <option value="Navotas City">MAdhya Pradesh</option>
                      <option value="Paranaque City">Uttar Pradesh</option>
                      <option value="Pasay City">Gujrat</option>
                      <option value="Pasig City">Uttrakhand</option>
                      <option value="Quezon City">Himachal Pradesh</option>
                      <option value="San Juan City">Punjab</option>
                      <option value="Taguig City">Tamil Nadu</option>
                      <option value="Valenzuela City">karela</option>
                      </select>  
                      </div>
