...
if (isset($_SESSION['id']) && trim($_SESSION['id']) != '') {
    ...
    if ($query) {
        ...
        if ($row) {
            ...
            echo 'No admin data found for the current user.';
            // You might want to redirect or handle this situation differently.
        }
    } else {
    ...
    echo 'Session ID is not set or empty';
    // You might want to redirect or handle this situation differently.
}
?>
    ...
    <div class="page-header page-header-small" filter-color="orange">
        <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/mb.jpg');"></div>
        <div class="container">
            <div class="content-center">
                ...
                <h2 class="title">
                    ...
                    // Check if the query was successful and if there is a valid row
                    if ($query && ($row = mysqli_fetch_array($query))) {
                        echo '' . $row['firstname'] . ' ' . $row['lastname'] . '';
                    } else {
                        echo 'User not found'; // Provide a default message or handle the case accordingly
                    }
                    ?>
                </h2>
