...
if ($query) {
    ...
    if ($row) {
        // Ensure 'firstname' is set in the $row array before accessing it
        $adminName = isset($row['firstname']) ? $row['firstname'] : 'Unknown';
        echo 'Admin ' . $adminName;
    } else {
        echo 'Admin'; // or handle the case when $row is null
    }
} else {
...
?>
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/keyboard.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        <img src="" class="rounded-circle">
                        <br><br>
                        <h3>Mobile phone , laptops , Smartwatch , Headphones, Sensors, and Electronic components.</h3>
                    </div>
                </div>
            </div>
        </div>
